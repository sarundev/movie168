    ...
    <div>
      ...
      <div className="sm:hidden grid grid-cols-3 gap-2">
        {mobileMovies.map((movie, idx) => {
          ...
          return (
            <Link key={movie.id} href={`/movie/${movie.slug}`} className="group cursor-pointer">
              <div
      ...
      >
        {movies.map(movie => (
          <Link key={movie.id} href={`/movie/${movie.slug}`} className="shrink-0">
